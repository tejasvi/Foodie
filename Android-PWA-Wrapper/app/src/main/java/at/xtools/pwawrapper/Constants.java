...
public class Constants {
    public Constants(){}
    // Root page
    public static String WEBAPP_URL = "https://f00die.herokuapp.com/";
    public static String WEBAPP_HOST = "herokuapp.com"; // used for checking Intent-URLs
    ...
    public static int PROGRESS_THRESHOLD = 98;
